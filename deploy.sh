...
echo -e "${GREEN}=====================================${NC}"
echo -e "${GREEN} Parcel Pilot - Deployment${NC}"
echo -e "${GREEN}=====================================${NC}"
...
echo -e "  Restart: ${YELLOW}docker-compose -f docker-compose.yml restart${NC}"
echo -e ""
...
echo -e "  4. Restart: ${YELLOW}docker-compose -f docker-compose.yml restart backend${NC}"
